...
// 						shards[0].GetName(): {
// 							"redis://" + *shards[0].Status.ShardNodes.Master,
// 							"redis://" + shards[0].Status.ShardNodes.Slaves[0],
// 							"redis://" + shards[0].Status.ShardNodes.Slaves[1],
// 						},
// 						shards[1].GetName(): {
// 							"redis://" + *shards[1].Status.ShardNodes.Master,
// 							"redis://" + shards[1].Status.ShardNodes.Slaves[0],
// 							"redis://" + shards[1].Status.ShardNodes.Slaves[1],
// 						},
// 					},
// 				},
// 			},
