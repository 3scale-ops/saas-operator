...
//
// $ bin/controller-gen object:headerFile=hack/boilerplate.go.txt paths=./pkg/basereconciler/test/basic_controller/api/v1alpha1
// $ bin/controller-gen crd:trivialVersions=true,preserveUnknownFields=false paths=./pkg/basereconciler/test/basic_controller/api/v1alpha1 output:crd:artifacts:config=./pkg/basereconciler/test/api/v1alpha1
