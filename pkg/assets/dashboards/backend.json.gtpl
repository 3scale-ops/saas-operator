  ...
  "panels": [
    ...
    },
    {
      ...
      "targets": [
        {
          "exemplar": true,
          "expr": "sum(rate(apisonator_listener_response_codes{namespace=\"$namespace\",pod!~\".*canary.*\"}[1m])) by (request_type)",
          "format": "time_series",
          "interval": "1m",
          "intervalFactor": 10,
        ...
        },
        {
          ...
          "interval": "1m",
          "intervalFactor": 10,
          "legendFormat": "{{`{{request_type}}`}}-canary",
          "refId": "B"
        }
      ],
      "thresholds": [],
      ...
      "timeRegions": [],
      "timeShift": null,
      "title": "Total listener requests per second (by request type)",
      "tooltip": {
        "shared": true,
        "sort": 2,
    ...
    },
    {
      ...
      "targets": [
        {
          "exemplar": true,
          "expr": "sum(rate(apisonator_listener_response_codes{namespace=\"$namespace\",pod!~\".*canary.*\"}[1m])) by (resp_code)",
          "format": "time_series",
          "interval": "1m",
          "intervalFactor": 10,
      ...
      "timeRegions": [],
      "timeShift": null,
      "title": "Total listener requests per second (by response code)",
      "tooltip": {
        "shared": true,
        "sort": 2,
        "value_type": "individual"
    ...
    },
    {
      ...
      "targets": [
        {
          "exemplar": true,
          "expr": "sum(rate(apisonator_listener_response_times_seconds_bucket{namespace=\"$namespace\",request_type=\"authorize\",pod!~\".*canary.*\"}[1m])) by (le)",
          "format": "heatmap",
          "interval": "1m",
          "intervalFactor": 10,
          "legendFormat": "{{`{{le}}`}}",
    ...
    },
    {
      ...
      "timeFrom": null,
      "timeShift": null,
      "title": "Canary Authorize requests per second heatmap (by response time bucket in seconds)",
      "tooltip": {
        "show": true,
        "showHistogram": false
      },
    ...
    },
    {
      ...
      "targets": [
        {
          "exemplar": true,
          "expr": "sum(rate(apisonator_listener_response_times_seconds_bucket{namespace=\"$namespace\",request_type=\"authrep\",pod!~\".*canary.*\"}[1m])) by (le)",
          "format": "heatmap",
          "interval": "1m",
          "intervalFactor": 10,
          "legendFormat": "{{`{{le}}`}}",
    ...
    },
    {
      ...
      "timeFrom": null,
      "timeShift": null,
      "title": "Canary Authrep requests per second heatmap (by response time bucket in seconds)",
      "tooltip": {
        "show": true,
        "showHistogram": false
      },
    ...
    },
    {
      ...
      "targets": [
        {
          "exemplar": true,
          "expr": "sum(rate(apisonator_listener_response_times_seconds_bucket{namespace=\"$namespace\",request_type=\"report\",pod!~\".*canary.*\"}[1m])) by (le)",
          "format": "heatmap",
          "interval": "1m",
          "intervalFactor": 10,
          "legendFormat": "{{`{{le}}`}}",
    ...
    },
    {
      ...
      "timeFrom": null,
      "timeShift": null,
      "title": "Canary Report requests per second heatmap (by response time bucket in seconds)",
      "tooltip": {
        "show": true,
        "showHistogram": false
      },
    ...
    },
    {
      ...
      "targets": [
        {
          "exemplar": true,
          "expr": "sum(rate(apisonator_listener_response_times_seconds_bucket{namespace=\"$namespace\",request_type=\"authorize_oauth\",pod!~\".*canary.*\"}[1m])) by (le)",
          "format": "heatmap",
          "interval": "1m",
          "intervalFactor": 10,
          "legendFormat": "{{`{{le}}`}}",
    ...
    },
    {
      ...
      "timeFrom": null,
      "timeShift": null,
      "title": "Canary Authorize (oauth) requests per second heatmap (by response time bucket in seconds)",
      "tooltip": {
        "show": true,
        "showHistogram": false
      },
    ...
    },
    {
      ...
      "targets": [
        {
          "exemplar": true,
          "expr": "sum(rate(apisonator_listener_response_times_seconds_bucket{namespace=\"$namespace\",request_type=\"authrep_oauth\",pod!~\".*canary.*\"}[1m])) by (le)",
          "format": "heatmap",
          "interval": "1m",
          "intervalFactor": 10,
          "legendFormat": "{{`{{le}}`}}",
    ...
    },
    {
      ...
      "timeFrom": null,
      "timeShift": null,
      "title": "Canary Authrep (oauth) requests per second heatmap (by response time bucket in seconds)",
      "tooltip": {
        "show": true,
        "showHistogram": false
      },
    ...
    },
    {
      ...
      "targets": [
        {
          "exemplar": true,
          "expr": "sum(rate(apisonator_listener_internal_api_response_codes{namespace=\"$namespace\",pod!~\".*canary.*\"}[1m])) by (request_type)",
          "format": "time_series",
          "interval": "1m",
          "intervalFactor": 10,
          "legendFormat": "{{`{{request_type}}`}}",
      ...
      "timeRegions": [],
      "timeShift": null,
      "title": "Total listener Internal API requests per second (by request type)",
      "tooltip": {
        "shared": true,
        "sort": 2,
        "value_type": "individual"
    ...
    },
    {
      ...
      "targets": [
        {
          "exemplar": true,
          "expr": "sum(rate(apisonator_listener_internal_api_response_codes{namespace=\"$namespace\",pod!~\".*canary.*\"}[1m])) by (resp_code)",
          "format": "time_series",
          "interval": "1m",
          "intervalFactor": 10,
          "legendFormat": "{{`{{resp_code}}`}}",
      ...
      "timeRegions": [],
      "timeShift": null,
      "title": "Total listener Internal API requests per second (by response code)",
      "tooltip": {
        "shared": true,
        "sort": 2,
        "value_type": "individual"
    ...
    },
    {
      ...
      "targets": [
        {
          "exemplar": true,
          "expr": "sum(rate(apisonator_listener_internal_api_response_times_seconds_bucket{namespace=\"$namespace\",request_type=\"alerts\",pod!~\".*canary.*\"}[1m])) by (le)",
          "format": "heatmap",
          "interval": "1m",
          "intervalFactor": 10,
          "legendFormat": "{{`{{le}}`}}",
    ...
    },
    {
      ...
      "timeFrom": null,
      "timeShift": null,
      "title": "Canary Alerts requests per second heatmap (by response time bucket in seconds)",
      "tooltip": {
        "show": true,
        "showHistogram": false
      },
    ...
    },
    {
      ...
      "targets": [
        {
          "exemplar": true,
          "expr": "sum(rate(apisonator_listener_internal_api_response_times_seconds_bucket{namespace=\"$namespace\",request_type=\"application_keys\",pod!~\".*canary.*\"}[1m])) by (le)",
          "format": "heatmap",
          "interval": "1m",
          "intervalFactor": 10,
          "legendFormat": "{{`{{le}}`}}",
    ...
    },
    {
      ...
      "timeFrom": null,
      "timeShift": null,
      "title": "Canary Application Keys requests per second heatmap (by response time bucket in seconds)",
      "tooltip": {
        "show": true,
        "showHistogram": false
      },
    ...
    },
    {
      ...
      "targets": [
        {
          "exemplar": true,
          "expr": "sum(rate(apisonator_listener_internal_api_response_times_seconds_bucket{namespace=\"$namespace\",request_type=\"application_referrer_filters\",pod!~\".*canary.*\"}[1m])) by (le)",
          "format": "heatmap",
          "interval": "1m",
          "intervalFactor": 10,
          "legendFormat": "{{`{{le}}`}}",
    ...
    },
    {
      ...
      "timeFrom": null,
      "timeShift": null,
      "title": "Canary Referrer Filters requests per second heatmap (by response time bucket in seconds)",
      "tooltip": {
        "show": true,
        "showHistogram": false
      },
    ...
    },
    {
      ...
      "targets": [
        {
          "exemplar": true,
          "expr": "sum(rate(apisonator_listener_internal_api_response_times_seconds_bucket{namespace=\"$namespace\",request_type=\"applications\",pod!~\".*canary.*\"}[1m])) by (le)",
          "format": "heatmap",
          "interval": "1m",
          "intervalFactor": 10,
          "legendFormat": "{{`{{le}}`}}",
    ...
    },
    {
      ...
      "timeFrom": null,
      "timeShift": null,
      "title": "Canary Applications requests per second heatmap (by response time bucket in seconds)",
      "tooltip": {
        "show": true,
        "showHistogram": false
      },
    ...
    },
    {
      ...
      "targets": [
        {
          "exemplar": true,
          "expr": "sum(rate(apisonator_listener_internal_api_response_times_seconds_bucket{namespace=\"$namespace\",request_type=\"errors\",pod!~\".*canary.*\"}[1m])) by (le)",
          "format": "heatmap",
          "interval": "1m",
          "intervalFactor": 10,
          "legendFormat": "{{`{{le}}`}}",
    ...
    },
    {
      ...
      "timeFrom": null,
      "timeShift": null,
      "title": "Canary Integration Errors API requests per second heatmap (by response time bucket in seconds)",
      "tooltip": {
        "show": true,
        "showHistogram": false
      },
    ...
    },
    {
      ...
      "targets": [
        {
          "exemplar": true,
          "expr": "sum(rate(apisonator_listener_internal_api_response_times_seconds_bucket{namespace=\"$namespace\",request_type=\"events\",pod!~\".*canary.*\"}[1m])) by (le)",
          "format": "heatmap",
          "interval": "1m",
          "intervalFactor": 10,
          "legendFormat": "{{`{{le}}`}}",
    ...
    },
    {
      ...
      "timeFrom": null,
      "timeShift": null,
      "title": "Canary Events requests per second heatmap (by response time bucket in seconds)",
      "tooltip": {
        "show": true,
        "showHistogram": false
      },
    ...
    },
    {
      ...
      "targets": [
        {
          "exemplar": true,
          "expr": "sum(rate(apisonator_listener_internal_api_response_times_seconds_bucket{namespace=\"$namespace\",request_type=\"metrics\",pod!~\".*canary.*\"}[1m])) by (le)",
          "format": "heatmap",
          "interval": "1m",
          "intervalFactor": 10,
          "legendFormat": "{{`{{le}}`}}",
    ...
    },
    {
      ...
      "timeFrom": null,
      "timeShift": null,
      "title": "Canary Metrics requests per second heatmap (by response time bucket in seconds)",
      "tooltip": {
        "show": true,
        "showHistogram": false
      },
    ...
    },
    {
      ...
      "targets": [
        {
          "exemplar": true,
          "expr": "sum(rate(apisonator_listener_internal_api_response_times_seconds_bucket{namespace=\"$namespace\",request_type=\"service_tokens\",pod!~\".*canary.*\"}[1m])) by (le)",
          "format": "heatmap",
          "interval": "1m",
          "intervalFactor": 10,
          "legendFormat": "{{`{{le}}`}}",
    ...
    },
    {
      ...
      "timeFrom": null,
      "timeShift": null,
      "title": "Canary Service Tokens requests per second heatmap (by response time bucket in seconds)",
      "tooltip": {
        "show": true,
        "showHistogram": false
      },
    ...
    },
    {
      ...
      "timeFrom": null,
      "timeShift": null,
      "title": "Canary Services requests per second heatmap (by response time bucket in seconds)",
      "tooltip": {
        "show": true,
        "showHistogram": false
      },
    ...
    },
    {
      ...
      "targets": [
        {
          "exemplar": true,
          "expr": "sum(rate(apisonator_listener_internal_api_response_times_seconds_bucket{namespace=\"$namespace\",request_type=\"stats\",pod!~\".*canary.*\"}[1m])) by (le)",
          "format": "heatmap",
          "interval": "1m",
          "intervalFactor": 10,
          "legendFormat": "{{`{{le}}`}}",
    ...
    },
    {
      ...
      "timeFrom": null,
      "timeShift": null,
      "title": "Canary Stats requests per second heatmap (by response time bucket in seconds)",
      "tooltip": {
        "show": true,
        "showHistogram": false
      },
    ...
    },
    {
      ...
      "targets": [
        {
          "exemplar": true,
          "expr": "sum(rate(apisonator_listener_internal_api_response_times_seconds_bucket{namespace=\"$namespace\",request_type=\"usage_limits\",pod!~\".*canary.*\"}[1m])) by (le)",
          "format": "heatmap",
          "interval": "1m",
          "intervalFactor": 10,
          "legendFormat": "{{`{{le}}`}}",
    ...
    },
    {
      ...
      "timeFrom": null,
      "timeShift": null,
      "title": "Canary Usage Limits requests per second heatmap (by response time bucket in seconds)",
      "tooltip": {
        "show": true,
        "showHistogram": false
      },
    ...
    },
    {
      ...
      "targets": [
        {
          "exemplar": true,
          "expr": "sum(rate(apisonator_listener_internal_api_response_times_seconds_bucket{namespace=\"$namespace\",request_type=\"utilization\",pod!~\".*canary.*\"}[1m])) by (le)",
          "format": "heatmap",
          "interval": "1m",
          "intervalFactor": 10,
          "legendFormat": "{{`{{le}}`}}",
    ...
    },
    {
      ...
      "timeFrom": null,
      "timeShift": null,
      "title": "Canary Utilization requests per second heatmap (by response time bucket in seconds)",
      "tooltip": {
        "show": true,
        "showHistogram": false
      },
    ...
    },
    {
      ...
      "targets": [
        {
          "exemplar": true,
          "expr": "sum(rate(apisonator_worker_job_count{namespace=\"$namespace\",pod!~\".*canary.*\"} [1m])) by (type)",
          "format": "time_series",
          "interval": "1m",
          "intervalFactor": 10,
          "legendFormat": "{{`{{type}}`}}",
      ...
      "timeRegions": [],
      "timeShift": null,
      "title": "Total jobs per second (by job type)",
      "tooltip": {
        "shared": true,
        "sort": 2,
        "value_type": "individual"
    ...
    },
    {
      ...
      "targets": [
        {
          "exemplar": true,
          "expr": "sum(rate(apisonator_worker_job_runtime_seconds_bucket{namespace=\"$namespace\",type=\"ReportJob\",pod!~\".*canary.*\"}[1m])) by (le)",
          "format": "heatmap",
          "interval": "1m",
          "intervalFactor": 10,
          "legendFormat": "{{`{{le}}`}}",
    ...
    },
    {
      ...
      "timeFrom": null,
      "timeShift": null,
      "title": "Canary Report jobs per second heatmap (by runtime bucket in seconds)",
      "tooltip": {
        "show": true,
        "showHistogram": false
      },
    ...
    },
    {
      ...
      "targets": [
        {
          "exemplar": true,
          "expr": "sum(rate(apisonator_worker_job_runtime_seconds_bucket{namespace=\"$namespace\",type=\"NotifyJob\",pod!~\".*canary.*\"}[1m])) by (le)",
          "format": "heatmap",
          "interval": "1m",
          "intervalFactor": 10,
          "legendFormat": "{{`{{le}}`}}",
    ...
    },
    {
      ...
      "timeFrom": null,
      "timeShift": null,
      "title": "Canary Notify jobs per second heatmap (by runtime bucket in seconds)",
      "tooltip": {
        "show": true,
        "showHistogram": false
      },
