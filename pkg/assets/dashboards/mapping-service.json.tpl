    ...
    "panels": [
        ...
        },
        {
            ...
            "targets": [
                ...
                {
                    "expr": "sum(kube_pod_container_resource_requests_cpu_cores{namespace=~'$namespace', pod=~'mapping-service.*'}) by (pod)",
                    "format": "table",
                    "instant": true,
                    "intervalFactor": 2,
                    "legendFormat": "",
                ...
                {
                    "expr": "sum(kube_pod_container_resource_limits_cpu_cores{namespace=~'$namespace', pod=~'mapping-service.*'}) by (pod)",
                    "format": "table",
                    "instant": true,
                    "intervalFactor": 2,
                    "legendFormat": "",
