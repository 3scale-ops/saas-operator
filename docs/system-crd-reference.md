...
|        `sphinx.env.thinking.endpoint`        | `string`  |      No      |        `system-sphinx`        |                                                            The sphinx fqdb                                                            |
|       `sphinx.env.thinking.configFile`       | `string`  |      No      | `/opt/sphinx/etc/sphinx.conf` |                                                    Sphinx configuration file path                                                     |
|         `sphinx.env.thinking.dbPath`         | `string`  |      No      |         `/opt/sphinx`         |                                                         Sphinx database path                                                          |
|        `sphinx.env.thinking.pidFile`         | `string`  |      No      |    `/var/run/searchd.pid`     |                                                         Sphinx PID file path                                                          |
