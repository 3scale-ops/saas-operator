...
| *`metrics`* __xref:{anchor_prefix}-github-com-3scale-saas-operator-api-v1alpha1-metricsspec[$$MetricsSpec$$]__ | Options for configuring metrics publication (will be deprecated on future releases)
