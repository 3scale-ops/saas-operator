...
| *`secretStoreRef`* __xref:{anchor_prefix}-github-com-3scale-saas-operator-api-v1alpha1-vaultsecretstorereferencespec[$$VaultSecretStoreReferenceSpec$$]__ | The Vault secret store reference
| *`refreshInterval`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.19/#duration-v1-meta[$$Duration$$]__ | The Vault refresh interval of the secret (duration)
|===


[id="{anchor_prefix}-github-com-3scale-saas-operator-api-v1alpha1-vaultsecretstorereferencespec"]
==== VaultSecretStoreReferenceSpec 

VaultSecretStoreReferenceSpec is a reference to a secret store

.Appears In:
****
- xref:{anchor_prefix}-github-com-3scale-saas-operator-api-v1alpha1-vaultsecretreference[$$VaultSecretReference$$]
****

[cols="25a,75a", options="header"]
|===
| Field | Description
| *`name`* __xref:{anchor_prefix}-github-com-3scale-saas-operator-api-v1alpha1-string[$$string$$]__ | The Vault secret store reference name
| *`kind`* __xref:{anchor_prefix}-github-com-3scale-saas-operator-api-v1alpha1-string[$$string$$]__ | The Vault secret store reference kind
|===
